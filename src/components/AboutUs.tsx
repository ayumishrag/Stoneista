...
const AboutUs = () => {
  return (
    <div
      id="aboutUs"
      className="w-full pt-20 px-4 md:px-20"
    ...
    >
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-4 md:gap-5">
        <div
          className="md:flex-1 w-full h-60 md:h-100 aspect-video md:aspect-4/3 rounded relative overflow-hidden border"
        ...
        >
          <Image
            ...
            alt="Hero Background"
            fill
            className="object-contain our-story-image"
          />
        </div>
        <div
          className="md:flex-1 text-2xl p-4 md:p-4 pt-5 md:pt-0"
        ...
        >
          <p className="text-[16px] md:text-2xl md:leading-8 font-normal">
            ...
            <br />
            <br />
            Because your home deserves nothing less than the extraordinary.
          </p>
        </div>
      </div>
    </div>
